...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Apicreativehubio.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.sandbox.tps-test.io
     */
    this.basePath = 'https://api.sandbox.tps-test.io'.replace(/\/+$/, '');
